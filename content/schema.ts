...
export const homePageSchema = z.object({
  ...
  aiBand: z.object({ eyebrow: z.string(), heading: z.string(), headingItalic: z.string().optional(), supportLine: z.string(), body: z.string(), cta: link }),
