      ...
      <section className="bg-card py-20 md:py-28">
        <div className="section-shell grid gap-20 lg:grid-cols-[1.2fr_0.8fr] lg:gap-28">
          ...
          <aside className="flex flex-col gap-12">
            <div><h2 className="text-heading leading-tight tracking-[-0.04em] md:text-display-xs">Based in London, working globally.</h2><p className="mt-5 text-lg leading-relaxed text-muted-foreground">We partner with ambitious founders and teams worldwide to design products that define industries.</p></div>
