      ...
      <section className="bg-background px-6 pb-20 pt-44 md:px-16 md:pb-28 md:pt-56">
        <div className="mx-auto grid max-w-7xl items-center gap-10 lg:grid-cols-[1.15fr_0.85fr]">
          <div>
            ...
            <h1 className="mt-10 max-w-4xl text-[48px] font-medium leading-[0.98] tracking-[-0.06em] md:text-[72px]">Let&apos;s start a<br />conversation</h1>
      ...
      <section className="bg-card px-6 py-20 md:px-16 md:py-28">
        <div className="mx-auto grid max-w-7xl gap-20 lg:grid-cols-[1.2fr_0.8fr] lg:gap-28">
          ...
          <aside className="flex flex-col gap-12">
            <div><h2 className="text-[32px] leading-tight tracking-[-0.04em] md:text-[40px]">Based in London, working globally.</h2><p className="mt-5 text-lg leading-relaxed text-muted-foreground">We partner with ambitious founders and teams worldwide to design products that define industries.</p></div>
            <div className="flex flex-col gap-10 text-base"><div><p className="text-sm uppercase tracking-[0.08em] text-muted-foreground">Email us</p><a className="mt-3 block text-xl text-primary" href={`mailto:${global.footer.contact.email}`}>{global.footer.contact.email}</a></div><div><p className="text-sm uppercase tracking-[0.08em] text-muted-foreground">Call us</p><a className="mt-3 block text-xl" href={`tel:${global.footer.contact.phone}`}>{global.footer.contact.phone}</a></div><div><p className="text-sm uppercase tracking-[0.08em] text-muted-foreground">Our studio</p><p className="mt-3 text-xl leading-relaxed">84 Clerkenwell Road<br />London, EC1M 5RJ<br />United Kingdom</p></div></div>
