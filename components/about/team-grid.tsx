...
const GRID_CARDS: GridCard[] = [
  ...
  },
  {
    ...
    id: "box2-manali",
    accent: "yellow",
    photoSrc: ph("Manali Rangnekar", 300, 314),
  ...
  },
  {
    ...
    id: "box3-prerna",
    accent: "blue",
    photoSrc: ph("Prerna Dwivedi", 400, 430),
    name: "Prerna Dwivedi",
    role: "UI / UX Designer",
  ...
  },
  {
    ...
    id: "box5-aarya",
    accent: "orange",
    photoSrc: ph("Aarya Trivedi", 410, 519),
    name: "Aarya Trivedi",
    role: "UI / UX Designer",
    top: 374,
    left: 833,
  ...
  },
  {
    ...
    id: "box8-vrishti",
    accent: "yellow",
    photoSrc: ph("Vrishti Purohit", 260, 362),
  ...
  },
  {
    ...
    id: "box9-rohit",
    accent: "lavender",
    photoSrc: ph("Rohit Potnis", 518, 421),
    name: "Rohit Potnis",
    role: "UI / UX Designer",
    top: 1065,
    left: 725,
  ...
  },
  {
    ...
    id: "box13-marcus",
    accent: "blue",
    photoSrc: ph("Marcus Thorne", 300, 451),
    name: "Marcus Thorne",
    role: "UI / UX Designer",
...
export function TeamGrid() {
  return (
    <section className="bg-background  py-14 -ml-[36px] md:py-20">
      <div
      ...
      <div className="flex items-center justify-center rounded-2xl border border-dashed border-border py-24 text-center text-sm text-muted-foreground md:hidden">
        Team carousel coming soon (mobile)
      </div>
    </section>
  );
}
