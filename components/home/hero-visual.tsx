...
export function HeroVisual() {
  return (
    <div className="relative w-[min(820px,52vw)]">
      ...
      <p className="type-sans-medium mt-2 text-right text-caption leading-[16.5px] tracking-[3.3px] uppercase text-[#36454F]/60 mr-[10px]">
